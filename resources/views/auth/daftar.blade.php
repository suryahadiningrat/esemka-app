  ...
  <body id="body" style="font-weight: bold;">
    <div class="preloader">
      ...
      <div class="container jarak justify-content-center">
          ...
          <form class="form-custom" method="POST" action="{{ route('register') }}" onsubmit="return validatePassword()">
              @csrf
              <div class="form-group">
                  <label for="nama">Nama Lengkap Anda</label>
                  <input name="name" type="text" class="form-control" id="nama" placeholder=" Nama Lengkap Anda" required>
              </div>
              
              <div class="form-group">
                  <label for="email">E-mail</label>
                  <input name="email" type="email" class="form-control" id="email" placeholder=" E-Mail Anda" onkeyup="validatePassword()" required>
              </div>
          ...
          <div class="d-flex justify-content-around mb-5">
              <a href="#google" class="api google">
                  <i class="fab fa-google"></i>
              </a>
              
              <a href="#facebook" class="api facebook">
                  <i class="fab fa-facebook"></i>
              </a>    
           
              <a href="#line" class="api line">
